   ...
   public static void setupSettings() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if (field.getName().contains("$") && !Modifier.isFinal(field.getModifiers())) {
            ...
            try {
               HyzenWriter.YamlEntryInfo entryInfo = (HyzenWriter.YamlEntryInfo)field.getAnnotation(HyzenWriter.YamlEntryInfo.class);
               Object value;
               List l;
               ArrayList list;
               Iterator var11;
               ...
               if (CONFIG.contains(nativeName)) {
                  ...
                  writer.set(nativeName, new HyzenWriter.YamlEntry(new Object[]{entryInfo == null ? "" : entryInfo.annotation(), CONFIG.get(nativeName)}));
               } else {
                  ...
                  save = true;
                  writer.set(nativeName, new HyzenWriter.YamlEntry(new Object[]{entryInfo == null ? "" : entryInfo.annotation(), value}));
               }
