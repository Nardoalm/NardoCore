...
public class BungeeYamlConfiguration extends YamlConfigurationn {
   ...
   public boolean reload() {
      try {
         ...
         Bungee.getInstance().getLogger().log(Level.SEVERE, "Unexpected error ocurred reloading file " + this.file.getName() + ": ", var2);
         return false;
      }
   }
   ...
   public boolean save() {
      try {
         ...
         Bungee.getInstance().getLogger().log(Level.SEVERE, "Unexpected error ocurred saving file " + this.file.getName() + ": ", var2);
         return false;
      }
   }
}
